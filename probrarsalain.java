...
public class probrarsalain extends JFrame {
	static Salacine sala13;
	...
	sala13 = new Salacine(6,7);
			sala13.llenarSalaPorDefecto();
			sala13.imprimirSala();
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					probrarsalain frame = new probrarsalain();
	...
	Cartelera uno = new Cartelera();
	uno.setVisible(rootPaneCheckingEnabled);
...
protected void comprarEntrada() {
	...
	;
		...
		do {
			...
			flag = sala13.verificarAsiento(comprarfila, comprarcolumna);
			
			sala13.comprarBoleto(comprarfila, comprarcolumna);
		}while (!flag);
