...
public class Salados extends JFrame {

	static Salacine sala2;
	...
	public static void main(String[] args) {
		...
		sala2 = new Salacine(6,7);
		sala2.llenarSalaPorDefecto();
		sala2.imprimirSala();
		
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Salados frame = new Salados();
	...
	public Salados() {
		...
		lblNewLabel_3.setIcon(new ImageIcon("F:\\usuarios\\alumno\\Descargas\\install\\app worvwnch\\data\\liger.jpg"));
	...
	public static void comprarBoletos() {
		...
		int comprarcolumna = 0;
			...
			do {
				...
				flag = sala2.verificarAsiento(comprarfila, comprarcolumna);
				
				
			}while (!flag);
			
			
			sala2.comprarBoleto(comprarfila, comprarcolumna);
