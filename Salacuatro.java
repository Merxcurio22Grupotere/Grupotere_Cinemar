...
public class Salacuatro extends JFrame {
	static Salacine sala4;
	...
	public static void main(String[] args) {
		...
		sala4 = new Salacine(6,7);
		sala4.llenarSalaPorDefecto();
		sala4.imprimirSala();
		
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Salacuatro frame = new Salacuatro();
	...
	public Salacuatro() {
		...
		lblNewLabel_3.setIcon(new ImageIcon("F:\\usuarios\\alumno\\Descargas\\install\\app worvwnch\\data\\juarico.jpg"));
	...
	public static void comprarBoletos() {
		...
		int comprarcolumna;
			...
			do {
				...
				flag = sala4.verificarAsiento(comprarfila, comprarcolumna);
				
				
			}while (!flag);
			
			
			sala4.comprarBoleto(comprarfila, comprarcolumna);
	...
	protected void Volvermenu() {
		this.dispose();
		Menugeneral cartelera = new Menugeneral();
