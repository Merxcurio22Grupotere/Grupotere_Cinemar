...
public class Salatres extends JFrame {

	static Salacine sala3;
	...
	public static void main(String[] args) {
		...
		sala3 = new Salacine(6,7);
		sala3.llenarSalaPorDefecto();
		sala3.imprimirSala();
		
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Salatres frame = new Salatres();
	...
	public Salatres() {
		...
		lblNewLabel_3.setIcon(new ImageIcon("F:\\usuarios\\alumno\\Descargas\\install\\app worvwnch\\data\\Sing2.jpg"));
	...
	public static void comprarBoletos() {
		...
		int comprarcolumna;
			...
			do {
				...
				flag = sala3.verificarAsiento(comprarfila, comprarcolumna);
				
				
			}while (!flag);
			
			
			sala3.comprarBoleto(comprarfila, comprarcolumna);
